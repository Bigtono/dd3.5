...
if(!empty($n)):
  if ($n=="n"):
    // création d'une note
    $requete = "INSERT INTO dd_notes (no_nom, no_tyno_id, no_cumulatif, no_texte_basique, no_texte_intermediaire, no_texte_avance, no_texte_expert, no_date, no_redacteur) VALUES ('".
