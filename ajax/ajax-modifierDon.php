...
if(isset($_POST['don'])):
  ...
  $result.='  <div class="ligne"><div class="label w90">Page</div><input id="mp_do_page_source" class="input_page" value="'.stripslashes($don_page_source).'"></div>';

  $result.='  <div class="ligne"><div class="label w90">Version</div><input id="mp_do_version" class="input_version" value="'.stripslashes($don_version).'"></div>'; 

  $result.='  <input class="bouton" type="button" name="validModifDon" id="validModifDon" value="'.$libelle.'" onClick="validerModifDon()">';
  $result.='  <input class="bouton ml15" type="button" name="annuleModifDon" id="annuleModifDon" value="Annuler" onClick="annulerPageModif()"></div>';
  $result.='</div>'; 
