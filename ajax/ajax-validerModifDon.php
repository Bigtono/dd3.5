...
if (isset($_POST['mp_do_id'])):
  if ($_POST['mp_do_id'] == "n"):
    // création d'un don
    $requete = "INSERT INTO dd_dons (do_nom, do_dado_id, do_texte, do_res_id, do_resume, do_ruleset_var_id) VALUES ('" .
  ...
  echo $q . "@" . $requete . "@" . $_POST['mp_do_nom'] . "@" . libelle("dd_dons", "do", "nom", $_POST['mp_do_dado_id']) . "@" . $_POST['mp_do_resume'] . "@" . $_POST['mp_do_resume'] . "@" . libelle("dd_ressources", "res", "abreviation", $_POST['mp_do_res_id']);
else:
