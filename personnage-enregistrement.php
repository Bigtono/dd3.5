...
if (isset($_POST['ok']) && !empty($p)):
    ...
    $message=1;
		...
		$sql="INSERT INTO dd_personnages (pe_nom, pe_ra_id, pe_arc_id, pe_sexe, pe_al_id, pe_org_id, pe_for, pe_dex, pe_con, pe_int, pe_sag, pe_cha, pe_background, pe_notes, pe_notes_mj, pe_j_id) VALUES ('".addslashes($_POST['mp_pe_nom'])."', '".$_POST['mp_pe_ra_id']."', '".$_POST['mp_pe_arc_id']."', '".$_POST['mp_pe_sexe']."', '".$_POST['mp_pe_al_id']."', '".$_POST['mp_pe_org_id']."', '".$_POST['mp_pe_for']."', '".$_POST['mp_pe_dex']."', '".$_POST['mp_pe_con']."', '".$_POST['mp_pe_int']."', '".$_POST['mp_pe_sag']."', '".$_POST['mp_pe_cha']."', '". addslashes($_POST['mp_pe_background'])."', '". addslashes($_POST['mp_pe_notes'])."', '". addslashes($_POST['mp_pe_notes_mj'])."', '". addslashes($_POST['mp_pe_j_id'])."')";
		$resultat = execPDO($sql);
