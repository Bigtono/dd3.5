      ...
      <form action="personnage-enregistrement.php?personnage=<? echo $p; ?>&tri=<? echo $_GET['tri']; ?>" class="formulaire" method="post" name="modif-personnage" id="modif-personnage">
        ...
        <div id="description" class="principal">
          <div class="info_personnage">
            <div><div class="label">Nom</div><input type="text" id="mp_pe_nom" name="mp_pe_nom" value="<? echo $dn['pe_nom']; ?>" class="input_left"></div>
            <div><div class="label">Race</div><? echo $race; ?></div>
            <div><div class="label">Archetype</div><? echo $archetype; ?></div>
            <div><div class="label">Sexe</div><input type="text" id="mp_pe_sexe" name="mp_pe_sexe" value="<? echo $dn['pe_sexe']; ?>" class="input_left"></div>
            <div><div class="label">Alignement</div><? echo $alignement; ?></div>
            <div><div class="label">Organisation</div><? echo $organisation; ?></div>              
          </div>
          <div class="info_personnage">
          ...
          <? if ($isAdmin): ?>
            <div class="info_personnage">
              <div><div class="label">Joueur</div><select id="mp_pe_j_id" name="mp_pe_j_id"><? echo OptionListeJoueurs($j); ?></select></div>
            </div>
          <? else: ?>
