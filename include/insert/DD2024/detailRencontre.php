  <?
  //************************************************************************************************************************
  // Recherche et affichage du détail d'une rencontre - DD2024
  //************************************************************************************************************************
       
  
  // Scénario et chapitre
  $renc='<div class="ligne"><div class="label w75">Scénario</div><div>'.$rencontre['sc_nom'].'</div></div>';
  $renc.='<div class="ligne"><div class="label w75">Chapitre</div><div>'.$rencontre['scc_nom'].'</div></div>';
  ...
  if ($num_rows>0):  
    ...
    while($dn = $result->fetch(PDO::FETCH_ASSOC)):         
      ...
      $contenu.='     
      <div id="mo'.$dn['mo_id'].'" class="monstre contenu is-active"> 
        <div class="titreAction">
          ...
          <div>
            ...
            <a href="monstre-modifier.php?mo='.$dn['mo_id'].'&re='.$re.'&retour=rencontre"><i class="icon fa-solid fa-pen-to-square"></i></a>
          </div>
        </div>            
    ...
    $renc.='<div class="nodata">Aucun monstre n\'a encore été ajouté à cette rencontre</div>';
  endif;
  ?>