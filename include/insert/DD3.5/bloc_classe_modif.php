...
<div class="ligne">
  <div class="label200">Intitul&eacute; Pouvoir 1</div><input type="text" class="input_pouvoir" id="mp_cla_pouvoir1" name="mp_cla_pouvoir1" value="<? echo stripslashes($dn['cla_pouvoir1']); ?>">
</div>
<div class="ligne">
  <div class="label200">Intitul&eacute; Pouvoir 2</div><input type="text" class="input_pouvoir" id="mp_cla_pouvoir2" name="mp_cla_pouvoir2" value="<? echo stripslashes($dn['cla_pouvoir2']); ?>">
</div>
<div class="ligne">
  <div class="label200">Intitul&eacute; Pouvoir 3</div><input type="text" class="input_pouvoir" id="mp_cla_pouvoir3" name="mp_cla_pouvoir3" value="<? echo stripslashes($dn['cla_pouvoir3']); ?>">
</div>
<div class="ligne">
  <div class="label200">Intitul&eacute; Pouvoir 4</div><input type="text" class="input_pouvoir" id="mp_cla_pouvoir4" name="mp_cla_pouvoir4" value="<? echo stripslashes($dn['cla_pouvoir4']); ?>">
</div>
...
<script>
  CKEDITOR.replace('mp_cla_description');
</script>

<div class="label_long mt10">Conditions (classe de prestige uniquement)</div><textarea id="mp_cla_conditions" name="mp_cla_conditions" class="input_notes"><? echo $dn['cla_conditions']; ?></textarea>
<script>
...
<div class="label_long mt10">Armes et armures</div><textarea id="mp_cla_armes" name="mp_cla_armes" class="input_notes"><? echo $dn['cla_armes']; ?></textarea>
<script>
  CKEDITOR.replace('mp_cla_armes');
</script>

<div class="label_long mt10">Sorts</div><textarea id="mp_cla_sorts" name="mp_cla_sorts" class="input_notes"><? echo $dn['cla_sorts']; ?></textarea>
<script>
  CKEDITOR.replace('mp_cla_sorts');
</script>
