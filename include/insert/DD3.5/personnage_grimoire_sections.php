...
<?php else: ?>
  <div id="pg-root" class="personnage-grimoire" data-ruleset="DD3.5">
    ...
    <div class="personnage-section">
      <div class="titre personnage-section-toggle">
        <div class="gras mr10 lien" onClick="togglePlus('pg-slots-section')">
          <span class="personnage-section-title">
            <i class="fa-solid fa-table-cells-large personnage-section-icon"></i>
            <span>Nombre de sorts par jour</span>
          </span>
          <span id="toggle-pg-slots-section"><i class="fa-solid fa-bars"></i></span>
        </div>
      </div>
      <div id="pg-slots-section" class="accordion-content noDisplay box-data">
        <div id="pg-slots-table"></div>
      </div>
    </div>
