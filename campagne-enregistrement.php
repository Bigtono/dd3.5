...
if ($camp_id > 0):
  ...
  $sql = "INSERT INTO dd_campagnes (camp_nom, camp_ruleset_var_id, camp_j_id, camp_resume, camp_description) VALUES ('" . addslashes($_POST['mp_camp_nom']) . "', '" . $_SESSION['ruleset'] . "', '" . $_POST['mp_camp_j_id'] . "', '" . addslashes($_POST['mp_camp_resume']) . "', '" . addslashes($_POST['mp_camp_description']) . "')";
  $resultat = execPDO($sql);
